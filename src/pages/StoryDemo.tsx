...
const StoryDemo = () => {
  ...
  // Remove useEffect that tries to fetch and generate on mount with a storyId

  const generatePublicStory = async () => {
    ...
    try {
      // Use a public profile ID that will save to database
      const storyId = await StoryGenerator.generateStory('public-demo', 'adventure');
      if (storyId) {
      ...
      console.error('Error generating public story:', error);
      ...
      <div className="text-center">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl p-8 shadow-2xl max-w-md mx-auto">
          <p className="font-fredoka text-xl text-gray-700 mb-6">
            Ready to hear a magical story created just for you by AI? This story will be saved and accessible to everyone!
          </p>
          ...
          >
            {isGenerating ? 'AI is Creating Your Story... ⚡' : 'Generate Public AI Story! ✨'}
          </Button>

          <p className="font-fredoka text-sm text-gray-600 mt-4">
            {isGenerating ? 'This usually takes 8-15 seconds...' : 'Each story is uniquely generated by AI and saved for everyone to enjoy!'}
          </p>
        </div>
      </div>
    </div>
